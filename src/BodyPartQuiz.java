...
public class BodyPartQuiz {
	...
	private void startQuiz() {
		...
		if (guess.equals("arnold")) {
			...
			JOptionPane.showMessageDialog(null, "You are CORRECT! Your score has increased by 1");
		...
		if(guess2.equals("Leonardo")) {
			...
			JOptionPane.showMessageDialog(null, "You are CORRECT! Your score increased by 1");
			score= score+1;
		}
		...
		if(guess3.equals("Morgan Freeman")) {
			...
			JOptionPane.showMessageDialog(null, "You are wrong! This is Morgan Freeman");
		}
		...
		if(guess4.equals("Jack Black")) {
			...
			JOptionPane.showMessageDialog(null, "You are wrong! This is  Jack Black");
